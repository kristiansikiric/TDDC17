...
(define (domain logistics)
  ...
  (:predicates
   ...
   ;; Static predicates:
   (smallobject ?so) (bigobject ?bo) (object ?o) (truck ?t) (airplane ?p) (train ?tr)
   (smallvehicle ?sv) (bigvehicle ?bv) (vehicle ?v)
   (location ?l) (airport ?a) (city ?c) (loc ?l ?c) (trainstation ?s)
  ...
  (:action loadbig
    :parameters (?o ?bv ?l)
    :precondition (and (object ?o) (bigvehicle ?bv) (location ?l)
           (at ?bv ?l) (at ?o ?l))
    :effect (and (in ?o ?bv) (not (at ?o ?l))))
  ...
  ;; Go by train between two stations.
  (:action goByTrain
    :parameters (?tr ?s1 ?s2)
    :precondition (and (train ?tr) (trainstation ?s1) (trainstation ?s2)
           (at ?tr ?s1))
    :effect (and (at ?tr ?s2) (not (at ?tr ?s1))))
  )
